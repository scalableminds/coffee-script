...
(function() {
  var Lexer, SourceMap, child_process, compile, ext, fork, formatSourcePosition, fs, helpers, lexer, loadFile, parser, patchStackTrace, patched, path, preprocessor, vm, _i, _len, _ref,
  ...
  exports.nodes = function(source, options) {
    if (typeof source === 'string') {
      return preprocessor(parser.parse(lexer.tokenize(source, options)));
    } else {
      return preprocessor(parser.parse(source));
    }
  };
